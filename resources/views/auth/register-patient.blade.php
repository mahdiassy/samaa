...
@section('content')
    <div class="register-section">
        <!-- Form Steps Content -->
        <form id="changePasswordForm" action="{{ route('registerPatient') }}" method="post" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-step personal-info active">
                ...
                <div class="button-container">
                    <button type="button" class="next-btn" onclick="validateAndGoToNext()">{{ __('site.Next') }}</button>
                </div>
            ...
            <div class="form-step medical-history">
                ...
                <div class="button-container">
                    <button type="button" class="prv-btn"
                        onclick="showPreviousStep()">{{ __('site.Previous') }}</button>
                </div>
