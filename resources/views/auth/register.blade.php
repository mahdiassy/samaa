            ...
            <div class="max-w-xl mx-auto">
                ...
                <div class="bg-white/10 backdrop-blur-lg rounded-3xl border border-white/20 shadow-2xl p-6 lg:p-8">
                    ...
                    <div class="text-center mb-8">
                        <div class="mb-4">
                            <div class="w-16 h-16 bg-gradient-to-br from-emerald-400 to-blue-400 rounded-2xl flex items-center justify-center mx-auto mb-3">
                    ...
                    <div class="space-y-3 mb-6">
                        ...
                        <a href="{{ route('showRegisterPatient') }}" 
                           class="group block w-full bg-gradient-to-r from-emerald-500 to-emerald-600 hover:from-emerald-600 hover:to-emerald-700 text-white rounded-xl p-4 transition-all duration-300 transform hover:scale-[1.02] hover:shadow-xl">
                            <div class="flex items-center justify-between">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div class="text-left">
                                        <h3 class="text-lg font-semibold">{{ __('site.Register as Patient') }}</h3>
                                        <p class="text-emerald-100 text-xs">{{ __('site.Receive personalized therapy') }}</p>
                                    </div>
                                </div>
                        ...
                        <a href="{{ route('showRegisterDoctor') }}" 
                           class="group block w-full bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white rounded-xl p-4 transition-all duration-300 transform hover:scale-[1.02] hover:shadow-xl">
                            <div class="flex items-center justify-between">
                                <div class="flex items-center gap-3">
                                    <div class="w-10 h-10 bg-white/20 rounded-lg flex items-center justify-center">
                                        <svg class="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <div class="text-left">
                                        <h3 class="text-lg font-semibold">{{ __('site.Register as Doctor') }}</h3>
                                        <p class="text-blue-100 text-xs">{{ __('site.Provide professional therapy') }}</p>
                                    </div>
                                </div>
                                <div class="transform group-hover:translate-x-1 transition-transform duration-300">
                                    <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="text-center border-t border-white/20 pt-4">
                        ...
                        <a href="{{ route('login') }}" 
                           class="inline-flex items-center gap-2 text-emerald-400 hover:text-emerald-300 font-medium transition-colors duration-200 text-sm">
                            {{ __('site.Sign In') }}
