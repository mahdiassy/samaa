            ...
            <div class="profile-details">
                <form action="{{ route('patient.store') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="visit-details">
                        <div class="user-info">
                            <div class="text-info">
                                ...
                                <input type="text" name="first_name" placeholder="{{ __('site.First Name') }}" value="{{ old('first_name') }}" class="styled-input" required>
                                @error('first_name')
                            ...
                            <div class="text-info">
                                ...
                                <input type="email" name="email" placeholder="{{ __('site.Email Address') }}" value="{{ old('email') }}" class="styled-input" required>
                                @error('email')
                                    <span class="error-message">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="text-info">
                                <p>{{ __('site.Phone') }}</p>
                                <input type="text" name="phone" placeholder="{{ __('site.Phone') }}" value="{{ old('phone') }}" class="styled-input">
                                @error('phone')
                                    <span class="error-message">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="text-info">
                                ...
                                <select name="language" class="styled-input" required>
                            ...
                            <div class="text-info">
                                ...
                                <select name="psychological_diseases[]" class="styled-input form-control select2 diseases-select-backend" multiple>
                            ...
                            <div class="text-info">
                                ...
                                <select name="therapeutic_areas" id="therapeutic_areas_select" class="styled-input" required>
                                ...
                                <div id="medication_input_wrapper" style="margin-top: 10px; {{ $showMedication ? '' : 'display: none;' }}">
                                    <label for="medications">{{ __('site.Please list the medications you are taking') }}</label>
                                    <input type="text" name="medications" id="medications" class="styled-input" placeholder="{{ __('site.Enter medication names') }}" value="{{ old('medications') }}">
                                </div>
                            </div>
                            ...
                            <div class="text-info">
                                ...
                                <select name="symptoms[]" class="styled-input form-control select2 diseases-select-backend" multiple>
                            ...
                            <div class="text-info">
                                ...
                                <select name="consultation" class="styled-input" required>
                        ...
                        <div class="diagnosis">
                            <div class="text-info">
                                <p>{{ __('site.Surname') }}</p>
                                <input type="text" name="last_name" placeholder="{{ __('site.Surname') }}" value="{{ old('last_name') }}" class="styled-input">
                                @error('last_name')
                                    <span class="error-message">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="text-info">
                                <p>{{ __('site.Country') }}</p>
                                <select name="country" class="styled-input" required>
                            ...
                            <div class="text-info">
                                ...
                                <input type="date" name="birthday" value="{{ old('birthday') }}" class="styled-input date-input">
                                @error('birthday')
                                    <span class="error-message">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="text-info">
                                ...
                                <input type="password" placeholder="XXXXXXXXXX" name="password" class="styled-input" required>
                                @error('password')
                                    <span class="error-message">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="text-info">
                                ...
                                <select name="nervouses[]" class="styled-input select2 diseases-select-backend" multiple>
                            ...
                            <div class="text-info">
                                ...
                                <select name="addiction" class="styled-input" required>
                            ...
                            <div class="text-info">
                                ...
                                <select name="incidents[]" class="styled-input form-control select2 diseases-select-backend" multiple>
                            ...
                            <div class="text-info">
                                ...
                                <select name="diseases[]" class="styled-input form-control select2 diseases-select-backend" multiple>
                    ...
                    <div class="action-buttons">
                        <button class="btn patient-btn" type="submit">{{ __('site.Create') }}</button>
                    </div>
                </form>
            </div>
        </div>
