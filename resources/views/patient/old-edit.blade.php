        ...
        <div class="card">
            <div class="card-content">
                <div class="card-body">
                    ...
                    <form novalidate action="{{ route('patient.update',$patient) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('put')
                            ...
                            <div class="tab-pane active" id="account" aria-labelledby="account-tab" role="tabpanel">
                                ...
                                <div class="media mb-2">
                                    <a class="mr-2" href="#"
                                        ...
                                        <img src="{{ Storage::url($patient->image) }}" alt="users avatar"
                                            ...
                                            <select class="form-control" name="role">
                                                @foreach ($roles as $role)
                                                    <option value="{{$role->name}}"
                                                        @if ($role->id == $patient->user->roles->pluck('id')->implode(', '))
                                                            selected
                                                        @endif
                                                        >{{$role->name}}
                                                    </option>
                                        ...
                                        <div class="form-group">
                                            <div class="controls position-relative">
                                                ...
                                                <input type="text" name="birthday"
                                                    ...
                                                    value="{{ old('birthday', $patient->birthday ? \Carbon\Carbon::parse($patient->birthday)->format('F, j, Y') : '') }}"
                                        ...
                                        <div class="form-group">
                                            <div class="controls">
                                                ...
                                                <input type="text" class="form-control" required
                                                    placeholder="Phone number" name="phone" value="{{ $patient->phone }}"
