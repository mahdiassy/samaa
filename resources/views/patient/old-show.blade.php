        ...
        <div class="row">
            <div class="col-12 col-sm-7">
                <div class="media mb-2">
                    <a class="mr-1" href="#">
                        <img src="{{ Storage::url($patient->image) }}" alt="users view avatar"
                            class="users-avatar-shadow rounded-circle" height="64" width="64">
                    </a>
                    <div class="media-body pt-25">
                        <h4 class="media-heading"><span class="users-view-name">{{ $patient->first_name }}
                                {{ $patient->last_name }}</span>
                        </h4>
                        <span>ID:</span>
                        <span class="users-view-id">{{ $patient->id }}</span>
                    </div>
                </div>
            </div>
            <div class="col-12 col-sm-5 px-0 d-flex justify-content-end align-items-center px-1 mb-2">
                <a href="{{ route('patient.index') }}" class="btn btn-sm mr-25 border">Back</a>
                        ...
                        <div class="col-12 col-md-4">
                            <table class="table table-borderless">
                                <tbody>
                                    <tr>
                                        <td>Registered:</td>
                                        <td>{{ \Carbon\Carbon::parse($patient->created_at)->format('d-m-Y') }}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Latest update: </td>
                                    ...
                                    <tr>
                                        <td>Patient Role: </td>
                                        <td class="users-view-latest-activity">
                                            {{$patient->user->roles->pluck('name')->implode(', ')}}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Verified: </td>
                    ...
                    <div class="col-12">
                        <table class="table table-borderless">
                            <tbody>
                                <tr>
                                    <td>First Name:</td>
                                    <td class="users-view-username">{{ $patient->first_name }}</td>
                                </tr>
                                <tr>
                                    <td>Last Name:</td>
                                ...
                                <tr>
                                    <td>E-mail:</td>
                                    <td class="users-view-email">{{ $patient->user->email }}</td>
                                </tr>
                            </tbody>
                        </table>
                        ...
                        <table class="table table-borderless">
                            <tbody>
                                <tr>
                                    <td>Twitter:</td>
                                    <td><a target="_blank" href="{{ $patient->twitter }}">{{ $patient->twitter }}</a></td>
                                </tr>
                                <tr>
                                    <td>Facebook:</td>
                                    <td><a target="_blank" href="{{ $patient->facebook }}">{{ $patient->facebook }}</a>
                                    </td>
                                </tr>
                                <tr>
                                    <td>Instagram:</td>
                                    <td><a target="_blank" href="{{ $patient->instagram }}">{{ $patient->instagram }}</a>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
