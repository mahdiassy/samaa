...
@section('content')
    <!-- Therapy Management Content with Consistent Layout -->
                ...
                @foreach($therapies as $therapy)
                    <div class="therapy-card" data-therapist="{{ $therapy->user->name }}" data-date="{{ $therapy->created_at->format('Y-m-d') }}">
                        ...
                        <div class="flex flex-wrap gap-2 mt-4">
                            @role('Patient')
                                <a href="#" class="inline-flex items-center gap-2 px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white text-sm font-medium rounded-lg transition-colors duration-200" onclick="bookTherapy({{ $therapy->id }})">
                            ...
                            <a href="{{ route('therapy.show', $therapy) }}" class="inline-flex items-center gap-2 px-4 py-2 bg-emerald-600 hover:bg-emerald-700 text-white text-sm font-medium rounded-lg transition-colors duration-200">
                                <svg class="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
                            ...
                            @role('Admin|Doctor')
                                <a href="{{ route('therapy.edit', $therapy) }}" class="inline-flex items-center gap-2 px-4 py-2 bg-amber-500 hover:bg-amber-600 text-white text-sm font-medium rounded-lg transition-colors duration-200">
                                    <svg class="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
                                ...
                                <button class="inline-flex items-center gap-2 px-4 py-2 bg-red-500 hover:bg-red-600 text-white text-sm font-medium rounded-lg transition-colors duration-200" onclick="deleteTherapy({{ $therapy->id }})">
                                    <svg class="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
