                    ...
                    <div class="custom-card-content">
                        <div class="form-section">
                            ...
                            <div class="image-upload-wrapper">
                                ...
                                <label for="image-upload" class="upload-label">
                                    <div class="image-placeholder">
                                        ...
                                        <div class="edit-icon">
                                            <img src="https://img.icons8.com/ios-filled/30/000000/edit.png"
                                                alt="Edit" />
                                        </div>
                                    </div>
                                </label>
                            ...
                            <div class="input-row">
                                ...
                                <div class="input-group">
                                    <label for="users-movies-select2">Patients:</label>
                                    <select class="form-input" id="users-movies-select2" name="patient_id">
                            ...
                            <div class="input-row">
                                <div class="input-group">
                                    ...
                                    <input type="file" class="form-input" id="audioFile" name="file" accept="audio/*">
                                </div>
                                <div class="input-group">
