                ...
                <div class="doctor-details">
                    ...
                    <div class="user-info">
                        <div class="extra-user-info">
                            <p class="big-title">salem yosef</p>
                            <div class="small-title">
                                <p>Patient</p>
                                <p>ID:#1234</p>
                            </div>
                            <div class="text-info">
                                <p><strong>Services/Procedures</strong></p>
                                <p>Skin cancer, Acne, Paediatric dermatology,</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="doctor-details">
                    ...
                    <div class="user-info">
                        ...
                        <div class="text-info">
                            ...
                            <p>FRCP (Lon), FRCP (Edin), FRCP (Glas), Postgraduate Diploma in Clinical Education, Diploma in
                                Dermatology, MRCP (UK) (Derm), MBBS, NTR University of Health Sciences (2004),</p>
                        </div>
                    </div>
                    <div class="diagnosis">
                        <div class="text-info">
                            <p><strong>Clinics</strong></p>
                            <p>Consultant Dermatologist, The Yorkshire Clinic - Ramsay Health Care, Bingley (present),
                                Consultant Dermatologist, Good Skin Days, Guiseley, Leeds (present), Consultant
                                Dermatologist,
                                Skin Surgery Clinic at Good Skin Days, Guiseley, Leeds (present),</p>
                        </div>
                    </div>
                </div>
                <div class="action-buttons">
                    <button class="btn patient-btn">Patient List</button>
                    <button class="btn patient-btn">+ Schedule Appointment</button>
                </div>
            </div>
        </div>
    </div>
