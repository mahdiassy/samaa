            ...
            <div class="profile-details">
                ...
                <div class="visit-details">
                    ...
                    <div class="diagnosis">
                        ...
                        <div class="text-info">
                            <p><strong>Diagnosis Of The Condition</strong></p>
                            <p>FRCP (Lon), FRCP (Edin), FRCP (Glas), Postgraduate Diploma in Clinical Education, Diploma in
                                Dermatology, MDGP (UK), MBBS, TNR University of Health Sciences (2004)</p>
                        </div>
                    </div>
                </div>
                <div class="action-buttons">
                    <button class="btn patient-btn">Patient List</button>
                    <button class="btn patient-btn">Feedback</button>
