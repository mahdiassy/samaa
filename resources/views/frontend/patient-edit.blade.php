            ...
            <div class="profile-details">
                ...
                <div class="visit-details">
                    ...
                    <div class="user-info">
                        <div class="text-info">
                            <p>Full Name</p>
                            <input type="text" value="Firas Reaaidi" class="styled-input" />
                        </div>
                        <div class="text-info">
                            <p>Injury name</p>
                            <input type="text" value="Diabetes" class="styled-input" />
                        </div>
                        <div class="text-info">
                            <p>Medicines</p>
                            <input type="text" value="Skin cancer, Acne, Paediatric dermatology," class="styled-input" />
                        </div>
                    </div>
                    <div class="diagnosis">
                        <div class="text-info">
                        ...
                        <div class="text-info">
                            <p>Diagnosis Of The Condition</p>
                            <textarea class="styled-input textarea-input">FRCP (Lon), FRCP (Edin), FRCP (Glas), Postgraduate Diploma in Clinical Education, Diploma in Dermatology, MRCP (UK) (Derm), MBBS, NTR University of Health Sciences (2004),</textarea>
                        </div>
                    </div>
                </div>
                <div class="action-buttons">
                    <button class="btn patient-btn">Save</button>
                </div>
            </div>
        </div>
    </div>
