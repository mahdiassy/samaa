        ...
        <div class="page-header">
            <div class="header-content">
                <div class="header-info">
                    <h1 class="page-title">{{ __('site.Add New Doctor') }}</h1>
                    <p class="page-subtitle">Build a trustworthy doctor profile with complete personal and professional insights.</p>
                </div>
        ...
        <div class="guideline-grid">
            <div class="guideline-card">
                ...
                <div class="guideline-content">
                    <h3>Highlight expertise</h3>
                    <p>Showcase the doctor’s speciality and qualifications to guide patient trust.</p>
                </div>
            </div>
            <div class="guideline-card">
                <div class="guideline-icon">
                ...
                <div class="guideline-content">
                    ...
                    <p>Ensure contact information and availability reflect the latest status.</p>
                </div>
            </div>
            <div class="guideline-card">
                <div class="guideline-icon">
                ...
                <div class="guideline-content">
                    <h3>Add a friendly touch</h3>
                    <p>Upload a professional photo and social links to humanize the profile.</p>
                </div>
            </div>
        </div>

        <div class="form-wrapper">
            <form action="{{ route('doctor.store') }}" method="post" enctype="multipart/form-data" class="doctor-create-form">
                @csrf
                ...
                <div class="form-shell">
                    <section class="form-panel media-panel">
                        <header class="panel-header">
                            ...
                            <p>Set a clear, friendly portrait that patients will recognise across the platform.</p>
                        </header>
                        ...
                        <div class="image-upload-wrapper">
                            ...
                            <label for="doctor-image" class="upload-label">
                                <div class="image-placeholder">
                                    <img id="doctor-image-preview" src="{{ asset('assets/images/avatar1.png') }}" alt="Doctor avatar preview" class="placeholder-img">
                                    <div class="edit-icon">
                                        <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                    ...
                    <section class="form-panel content-panel">
                        <header class="panel-header">
                            ...
                            <p>Complete the personal, professional, and social details that inform patients.</p>
                        </header>

                        <div class="section-block">
                            <div class="section-heading">
                                <h3>{{ __('site.Personal Information') }}</h3>
                                <p>Basic information used throughout the platform and for login.</p>
                            </div>
                            ...
                            <div class="input-grid two-col">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" id="specialization" name="specialization" class="form-input" placeholder="{{ __('site.Specialization') }}" value="{{ old('specialization') }}">
                        ...
                        <div class="section-block">
                            <div class="section-heading">
                                ...
                                <p>Help patients connect by sharing relevant professional profiles.</p>
                            </div>

                            <div class="input-grid two-col">
                                <div class="input-group span-2">
                                    <label for="facebook">{{ __('site.Facebook link') }}</label>
                                    <input type="url" id="facebook" name="facebook" class="form-input" placeholder="https://facebook.com/..." value="{{ old('facebook') }}">
                                    @error('facebook')
                                        <span class="error-message">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="input-group">
                                    ...
                                    <input type="url" id="twitter" name="twitter" class="form-input" placeholder="https://twitter.com/..." value="{{ old('twitter') }}">
                                    @error('twitter')
                                        <span class="error-message">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="input-group">
                                    ...
                                    <input type="url" id="instagram" name="instagram" class="form-input" placeholder="https://instagram.com/..." value="{{ old('instagram') }}">
                                    @error('instagram')
                                        <span class="error-message">{{ $message }}</span>
                                    @enderror
                                </div>
