    ...
    <div class="main-content">
        ...
        <div>
            <div class="profile-details">
                <form action="{{ route('profile.doctor.update', $doctor) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('put')
                    ...
                    <div class="visit-details">
                        ...
                        <div class="diagnosis">
                            <div class="text-info">
                                <p>{{ __('site.Surname') }}</p>
                                <input type="text" name="surname" placeholder="{{ __('site.Surname') }}" value="{{ $doctor->last_name }}"
                                    class="styled-input" />
                            </div>
                            <div class="text-info">
