                            ...
                            <div class="tab-pane active" id="account" aria-labelledby="account-tab" role="tabpanel">
                                ...
                                <div class="media mb-2">
                                    <a class="mr-2" href="#"
                                        ...
                                        <img src="{{ Storage::url($doctor->image) }}" alt="users avatar"
                                            ...
                                            <select class="form-control" name="role">
                                                @foreach ($roles as $role)
                                                    <option value="{{$role->name}}"
                                                        @if ($role->id == $doctor->user->roles->pluck('id')->implode(', '))
                                                            selected
                                                        @endif
                                                        >{{$role->name}}
                                                    </option>
                                        ...
                                        <div class="form-group">
                                            <div class="controls position-relative">
                                                ...
                                                <input type="text" name="birthday"
                                                    ...
                                                    value="{{ old('birthday', $doctor->birthday ? \Carbon\Carbon::parse($doctor->birthday)->format('F, j, Y') : '') }}"
                                        ...
                                        <div class="form-group">
                                            <div class="controls">
                                                ...
                                                <input type="text" class="form-control" required
                                                    placeholder="Phone number" name="phone" value="{{ $doctor->phone }}"
