<div class="search-bar" style="background-image: url('/assets/images/therapy.png');" autocomplete="off">
    <div class="search-bar-title">
        <h1>{{ __('site.start your') }}<br>{{ __('site.music therapy') }}</h1>
    </div>
    <div class="search-input-wrapper">
        <input type="text" id="doctor-search" placeholder="{{ __('site.Search doctors...') }}">
        <button>
        ...
        <div id="search-suggestions" class="suggestions-box-bar"></div>
    </div>
</div>
