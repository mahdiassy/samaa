    ...
    <main id="main-content" class="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-800">
            ...
            <div class="text-center max-w-5xl mx-auto">
                    @if(App::getLocale() == 'ar')
                        <h1 class="text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-serif font-bold mb-8 leading-tight">
                            <span class="text-white">{{ __('frontend/therapists.Empowering') }}</span>
                            <br>
                            <span class="bg-gradient-to-r from-orange-400 to-red-400 bg-clip-text text-transparent line-through decoration-4 decoration-orange-400">
                                {{ __('frontend/therapists.therapists') }}
                            </span>
                            <span class="text-white">{{ __('frontend/therapists.with') }} {{ __('frontend/therapists.therapy') }}</span>
                            <span class="bg-gradient-to-r from-blue-400 via-teal-400 to-emerald-400 bg-clip-text text-transparent">
                                {{ __('frontend/therapists.Sound') }}
                            </span>
                            <span class="text-white">{{ __('frontend/therapists.AI-Driven') }}</span>
                        </h1>
                    ...
                    @else
                        <h1 class="text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-serif font-bold mb-8 leading-tight">
                            ...
                            <span class="text-white">{{ __('frontend/therapists.with') }} {{ __('frontend/therapists.AI-Driven') }}</span>
                            <span class="bg-gradient-to-r from-blue-400 via-teal-400 to-emerald-400 bg-clip-text text-transparent">
                                {{ __('frontend/therapists.Sound') }}
                            </span>
                            <span class="text-white">{{ __('frontend/therapists.therapy') }}</span>
                </h1>
                    @endif
            </div>
        </div>
                    ...
                    <div class="bg-white/5 backdrop-blur-sm border border-white/10 rounded-3xl p-8 lg:p-10">
                        @if(App::getLocale() == 'ar')
                            <h2 class="text-3xl sm:text-4xl lg:text-5xl font-serif font-bold text-white mb-6">
                                {{ __('frontend/therapists.Join A') }}<br>
                                <strong class="text-white">{{ __('frontend/therapists.Revolution In') }} {{ __('frontend/therapists.therapy') }}</strong>
                                <span class="bg-gradient-to-r from-emerald-400 to-blue-400 bg-clip-text text-transparent">{{ __('frontend/therapists.Music') }}</span>
                            </h2>
                            <p class="text-lg text-slate-300 leading-relaxed mb-8">
                                {{ __('frontend/therapists.SAMAA equips therapists and institutions with AI tools to enhance traditional practices, backed by') }}
                                {{ __('frontend/therapists.groundbreaking research.') }} <strong class="text-orange-400">{{ __('frontend/therapists.Dr. Nadia Cheaib') }}</strong>
                            </p>
                        @elseif(App::getLocale() == 'fr')
                            <h2 class="text-3xl sm:text-4xl lg:text-5xl font-serif font-bold text-white mb-6">
                                {{ __('frontend/therapists.Join A') }}<br>
                                <strong class="text-white">{{ __('frontend/therapists.Revolution In') }}</strong>
                                <span class="bg-gradient-to-r from-emerald-400 to-blue-400 bg-clip-text text-transparent">{{ __('frontend/therapists.Music') }}</span>
                            </h2>
                            <p class="text-lg text-slate-300 leading-relaxed mb-8">
                                {{ __('frontend/therapists.SAMAA equips therapists and institutions with AI tools to enhance traditional practices, backed by') }}
                        ...
                        @else
                            ...
                            <p class="text-lg text-slate-300 leading-relaxed mb-8">
                                {{ __('frontend/therapists.SAMAA equips therapists and institutions with AI tools to enhance traditional practices, backed by') }}
                                <strong class="text-orange-400">{{ __('frontend/therapists.Dr. Nadia Cheaib') }}</strong> {{ __('frontend/therapists.groundbreaking research.') }}
                            </p>
                        @endif
                        
                        <div class="flex flex-wrap gap-4">
                            <div class="bg-white/10 rounded-2xl px-4 py-2 border border-white/20">
                                <span class="text-slate-300 text-sm">{{ __('frontend/therapists.Endorsed By The American European Music Therapy Association.') }}</span>
                            </div>
                            <div class="bg-white/10 rounded-2xl px-4 py-2 border border-white/20">
                                <span class="text-slate-300 text-sm">{{ __('frontend/therapists.Clinically Validated In Autism Studies') }}</span>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="relative bg-white/10 backdrop-blur-sm border border-white/20 rounded-3xl p-8 lg:p-10">
                                ...
                                <div class="bg-white/10 rounded-2xl p-6 border border-white/20">
                                    <p class="text-lg text-slate-300 italic mb-4">
                                        <em>{{ __('frontend/therapists.Therapists Are The Heart Of Healing') }} <strong class="text-white">SAMAA</strong> {{ __('frontend/therapists.Is Here To Amplify Your Impact.') }}</em>
                                    </p>
                                    <p class="text-sm text-slate-400">{{ __('frontend/therapists.Dr. Nadia’s') }}</p>
                        </div>
                            </div>
                    </div>
                </div>
        ...
        <section class="py-16 sm:py-20 lg:py-24 relative" data-animate="fade-in-up" data-delay="400">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="text-center mb-16">
                    <h2 class="text-3xl sm:text-4xl lg:text-5xl font-serif font-bold text-white mb-6">
                        {{ __('frontend/therapists.Benefits for') }} <span class="bg-gradient-to-r from-emerald-400 to-blue-400 bg-clip-text text-transparent">{{ __('frontend/therapists.therapists') }}</span>
                    </h2>
                    <p class="text-xl text-slate-300 mb-8">{{ __('frontend/therapists.Why Partner with SAMAA?') }}</p>
                    <div class="flex justify-center">
                ...
                <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                    ...
                    <div class="bg-white/5 backdrop-blur-sm border border-white/10 rounded-3xl p-8 text-center group hover:border-emerald-400/30 transition-all duration-300">
                        ...
                        <h3 class="text-xl font-serif font-bold text-white mb-4">{{ __('frontend/therapists.AI-Powered Tools:') }}</h3>
                        <p class="text-slate-300 leading-relaxed">
                            {{ __('frontend/therapists.Customize sessions using U-shaped sound therapy protocols, adapted in real-time for each patient.') }}
                        </p>
                    </div>
                    ...
                    <div class="bg-white/5 backdrop-blur-sm border border-white/10 rounded-3xl p-8 text-center group hover:border-blue-400/30 transition-all duration-300">
                        ...
                        <h3 class="text-xl font-serif font-bold text-white mb-4">{{ __('frontend/therapists.Progress Tracking:') }}</h3>
                        <p class="text-slate-300 leading-relaxed">
                            {{ __('frontend/therapists.Access dashboards to monitor behavioral improvements, sleep patterns, and sensory responses.') }}
                    </p>
                </div>
                    ...
                    <div class="bg-white/5 backdrop-blur-sm border border-white/10 rounded-3xl p-8 text-center group hover:border-teal-400/30 transition-all duration-300">
                        ...
                        <h3 class="text-xl font-serif font-bold text-white mb-4">{{ __('frontend/therapists.Global Collaboration:') }}</h3>
                        <p class="text-slate-300 leading-relaxed">
                            {{ __('frontend/therapists.Join a network of therapists and institutions pioneering ethical, tech-driven care') }}
                        </p>
                    </div>
                    ...
                    <div class="bg-white/5 backdrop-blur-sm border border-white/10 rounded-3xl p-8 text-center group hover:border-purple-400/30 transition-all duration-300">
                        ...
                        <h3 class="text-xl font-serif font-bold text-white mb-4">{{ __('frontend/therapists.Training & Support:') }}</h3>
                        <p class="text-slate-300 leading-relaxed">
                            {{ __('frontend/therapists.Free onboarding and access to SAMAA\'s research library') }}
                    </p>
                </div>
            </div>
        </div>
                ...
                <div class="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                    ...
                    <div class="bg-white/5 backdrop-blur-sm border border-white/10 rounded-3xl p-8 lg:p-10">
                        <h2 class="text-3xl sm:text-4xl font-serif font-bold text-white mb-8">
                            <span class="bg-gradient-to-r from-emerald-400 to-blue-400 bg-clip-text text-transparent">{{ __('frontend/therapists.samaa') }}</span>
                            <span class="text-white">{{ __('frontend/therapists.for Organizations') }}</span>
                        </h2>
                        ...
                        <div class="space-y-6">
                            <div class="flex items-start">
                                ...
                                <div>
                                    <h3 class="text-lg font-bold text-white mb-2">{{ __('frontend/therapists.Tailored Programs:') }}</h3>
                                    <p class="text-slate-300">{{ __('frontend/therapists.Integrate SAMAA into your wellness initiatives for autism, anxiety, or chronic pain.') }}</p>
                                </div>
                        </div>
                        ...
                        <div>
                                    <h3 class="text-lg font-bold text-white mb-2">{{ __('frontend/therapists.Data-Driven Insights:') }}</h3>
                                    <p class="text-slate-300">{{ __('frontend/therapists.Receive aggregated reports to measure program efficacy and secure funding') }}</p>
                        </div>
                    </div>
                            ...
                            <div class="flex items-start">
                                ...
                                <div>
                                    <h3 class="text-lg font-bold text-white mb-2">{{ __('frontend/therapists.Ethical Mission:') }}</h3>
                                    <p class="text-slate-300">{{ __('frontend/therapists.Align with Dr. Nadia Cheaib\'s vision: 10% of SAMAA\'s profits fund therapy for underserved communities.') }}</p>
                                </div>
                        </div>
                        </div>
                    </div>
        ...
        <section class="py-16 sm:py-20 lg:py-24 relative" data-animate="fade-in-up" data-delay="800">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="text-center mb-16">
                    <h2 class="text-3xl sm:text-4xl lg:text-5xl font-serif font-bold text-white mb-6">
                        {{ __('frontend/therapists.Get Started In') }} <span class="bg-gradient-to-r from-emerald-400 to-blue-400 bg-clip-text text-transparent">{{ __('frontend/therapists.3 Steps') }}</span>
                    </h2>
                    <div class="flex justify-center">
                        <div class="w-24 h-px bg-gradient-to-r from-transparent via-emerald-400 to-transparent"></div>
                    </div>
                ...
                <div class="grid md:grid-cols-3 gap-8">
                    ...
                    <div class="bg-white/5 backdrop-blur-sm border border-white/10 rounded-3xl p-8 text-center group hover:border-blue-400/30 transition-all duration-300">
                        ...
                        <h3 class="text-xl font-serif font-bold text-white mb-4">{{ __('frontend/therapists.Apply') }}</h3>
                        <p class="text-slate-300">{{ __('frontend/therapists.Fill Out A Short Form.') }}</p>
                        </div>
                    ...
                    <div class="bg-white/5 backdrop-blur-sm border border-white/10 rounded-3xl p-8 text-center group hover:border-emerald-400/30 transition-all duration-300">
                        ...
                        <h3 class="text-xl font-serif font-bold text-white mb-4">{{ __('frontend/therapists.Onboard') }}</h3>
                        <p class="text-slate-300">{{ __('frontend/therapists.Attend A 30-Minute Training Webinar.') }}</p>
                        </div>
                    ...
                    <div class="bg-white/5 backdrop-blur-sm border border-white/10 rounded-3xl p-8 text-center group hover:border-teal-400/30 transition-all duration-300">
                        ...
                        <h3 class="text-xl font-serif font-bold text-white mb-4">{{ __('frontend/therapists.Launch') }}</h3>
                        <p class="text-slate-300">{{ __('frontend/therapists.Access SAMAA\'s Portal And Start Healing') }}</p>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="py-16 sm:py-20 lg:py-24 relative" data-animate="fade-in-up" data-delay="1000">
            ...
            <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                <div class="bg-white/5 backdrop-blur-sm border border-white/10 rounded-3xl p-8 lg:p-12">
                    <h2 class="text-3xl sm:text-4xl lg:text-5xl font-serif font-bold text-white mb-6">
                        <span class="bg-gradient-to-r from-emerald-400 to-blue-400 bg-clip-text text-transparent">{{ __('frontend/therapists.Join') }}</span>
                        <span class="text-white">{{ __('frontend/therapists.therapists') }}</span>
                        <br>
                        <span class="text-white">{{ __('frontend/therapists.Transforming') }}</span>
                        <span class="bg-gradient-to-r from-blue-400 to-emerald-400 bg-clip-text text-transparent">{{ __('frontend/therapists.Lives') }}</span>
                    </h2>
                    
                    <p class="text-lg text-slate-400 mb-8 leading-relaxed">
                        {{ __('frontend/therapists.SAMAA complies with HIPAA/GDPR. Patient data is fully encrypted.') }}
                    </p>
                        ...
                        <a href="{{ route('login') }}" 
                           class="group px-8 py-4 bg-gradient-to-r from-blue-600 to-emerald-600 text-white font-semibold rounded-2xl text-lg hover:from-blue-700 hover:to-emerald-700 transform hover:scale-105 transition-all duration-300 shadow-xl hover:shadow-2xl hover:shadow-emerald-500/25">
                            <span class="flex items-center">
                                ...
                                @endif
                                {{ __('frontend/therapists.Join Our Wait List') }}
                                @if(App::getLocale() != 'ar')
                        ...
                        <a href="{{ route('contact-us') }}" 
                           class="group px-8 py-4 bg-white/10 backdrop-blur-sm border border-white/20 text-white font-semibold rounded-2xl text-lg hover:bg-white/20 hover:border-white/30 transform hover:scale-105 transition-all duration-300">
                            <span class="flex items-center">
                                ...
                                @endif
                                {{ __('frontend/therapists.Partner With SAMAA') }}
                                @if(App::getLocale() != 'ar')
                                    <svg class="w-5 h-5 ml-2 group-hover:translate-x-1 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <p class="text-sm text-slate-500">
                        {{ __('frontend/therapists.Inquire About') }} <a href="#" class="text-emerald-400 hover:text-emerald-300 underline">{{ __('frontend/therapists.Institutional Partnerships') }}</a>
                    </p>
            </div>
        </div>
    </section>
