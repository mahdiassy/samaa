                ...
                <div class="welcome-section">
                    <h1 class="dashboard-title">
                        ...
                        @if(Auth::check() && Auth::user()->hasRole('Patient'))
                            {{ Auth::user()->patient->first_name ?? Auth::user()->name }}
                        @elseif(Auth::check() && Auth::user()->hasRole('Doctor'))
                            Dr. {{ Auth::user()->doctor->first_name ?? Auth::user()->name }}
                   .therapy-cards {
            ...
            <div class="therapy-cards">
                <div class="therapy-card">
                    <div class="therapy-image">
                        <img src="{{ asset('assets/images/therapy-nature.jpg') }}" alt="Nature Sounds">
                    </div>
                ...
                <div class="therapy-card">
                    <div class="therapy-image">
                        <img src="{{ asset('assets/images/therapy-meditation.jpg') }}" alt="Meditation">
                    </div>
                    <div class="therapy-content">
                ...
                <div class="therapy-card">
                    <div class="therapy-image">
                        <img src="{{ asset('assets/images/therapy-sleep.jpg') }}" alt="Sleep Therapy">
                    </div>
                    <div class="therapy-content">
                        <h4>Sleep Stories</h4>
