    ...
    extend: {
      colors: {
        ...
        secondary: {
          ...
          300: '#5eead4',
          400: '#2dd4bf',
          500: '#2D6B69', // Secondary brand color
          600: '#1F4F4D',
          700: '#0f766e',
          800: '#115e59',
          900: '#134e4a',
      ...
      fontSize: {
        'hero': ['clamp(3.5rem, 8vw, 6rem)', { lineHeight: '1.1' }],
        'display': ['clamp(2.5rem, 5vw, 4rem)', { lineHeight: '1.2' }],
        'title': ['clamp(2rem, 4vw, 3rem)', { lineHeight: '1.3' }],
      },
      spacing: {
        '18': '4.5rem',
        '88': '22rem',
      ...
      backgroundImage: {
        ...
        'hero-pattern': 'linear-gradient(135deg, rgba(15, 74, 106, 0.9) 0%, rgba(45, 107, 105, 0.8) 100%)',
